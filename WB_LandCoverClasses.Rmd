...
Power (2006) reported an age class of more than 401 years for British Columbia. However, the oldest stand age found in the study area was 400 years in BCR 4 Fig.\@ref(fig:age). The Province Forest Inventories consistently use 10-yr age classes. Thus the present study will use the same approach.The maximum age class will be 141-150. 
